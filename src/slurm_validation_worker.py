...
class ValidationWorker:
    ...
    def _configure_reward_llm(self) -> tuple[LLMConfig, LLMConfig | None]:
        ...
        # The reward endpoint (1.95.77.23:3000) is only reachable through the
        # corporate forward proxy; direct access from this host times out. Clear
        # any inherited no_proxy so the reward endpoint isn't short-circuited.
        os.environ["NO_PROXY"] = ""
        os.environ["no_proxy"] = ""
